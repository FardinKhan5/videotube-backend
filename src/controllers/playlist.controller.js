...
const getUserPlaylists = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200,playlist,"User playlist fetched successfully"))
})
...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
    ...
    if(video){
        return res.status(200).json(new ApiResponse(200,{alreadyExists:true},"Video already exists in the playlist"))
    }
...
const getAllVideosInPlaylist=asyncHandler(async (req,res)=>{
    ...
    res.status(200).json(new ApiResponse(200,videos,"Videos from playlist fetched successfully"))
})
