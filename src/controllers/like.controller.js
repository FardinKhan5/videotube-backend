...
const toggleVideoLike = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, like, "Removed like from the video successfully")
    );
});
...
const toggleCommentLike = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, like, "Removed like from the comment successfully")
    );
});
...
const toggleTweetLike = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(
      new ApiResponse(200, like, "Removed like from the tweet successfully")
    );
});
